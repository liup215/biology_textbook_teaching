...
#align(center)[
#text(2em, strong("人体生理学综合总结"))
#linebreak()
#text(1.5em, strong("Human Physiology Comprehensive Summary"))
]

= 第7章 神经系统：神经元与突触 (Chapter 7: The Nervous System - Neurons and Synapses)
...
- 神经元功能分类：
  - *Sensory neurons* (感觉神经元)：将冲动从感受器传入CNS
  - *Motor neurons* (运动神经元)：将冲动从CNS传至效应器
  - *Interneurons* (中间神经元)：完全位于CNS内，整合感觉输入和运动输出
...
- *Action potential* (动作电位)：神经元的电信号
  ...
  - *Repolarization* (复极化)：#ce("K+")通道开放，膜电位恢复
...
- *Vestibular apparatus* (前庭器)：
  ...
  - *Utricle* (椭圆囊)和*saccule* (球囊)：线性加速度和重力
...
= 第11章 内分泌腺 (Chapter 11: Endocrine Glands)
...
= 第12章 肌肉：收缩机制与神经控制 (Chapter 12: Muscle)
...
- *Muscle fiber* (肌纤维)：肌肉细胞
  ...
  - *Sarcoplasmic reticulum* (SR, 肌浆网)：储存#ce("Ca2+")
...
- #ce("Ca2+")的作用：
  - 与troponin结合，移除tropomyosin对结合位点的阻断
  - 允许肌球蛋白与肌动蛋白结合

== 兴奋-收缩耦联 (Excitation-Contraction Coupling)

- 动作电位沿T-tubules传播
- *Dihydropyridine receptors* (DHP受体)激活
- SR释放#ce("Ca2+")通过*ryanodine receptors* (RyR受体)
- #ce("Ca2+")启动收缩
- 收缩结束：#ce("Ca2+")被泵回SR
...
= 第13章 血液、心脏与循环 (Chapter 13: Blood, Heart, and Circulation)
...
- *Formed elements* (血细胞)：
  - *Erythrocytes* (红细胞)：运输#ce("O2")和#ce("CO2")
    - 含*hemoglobin* (血红蛋白)
    - 无细胞核，寿命~120天
  - *Leukocytes* (白细胞)：免疫防御
  - *Platelets* (血小板)：凝血
...
= 第14章 心输出量、血流与血压 (Chapter 14: Cardiac Output, Blood Flow, and Blood Pressure)
...
- *Mean arterial pressure* (MAP, 平均动脉压) ≈ 舒张压 + 1/3(收缩压-舒张压)
- 血压 = *Cardiac output* × *Total peripheral resistance* (TPR, 总外周阻力)

== 血流调节 (Blood Flow Regulation)

- 局部调节：
  - *Metabolic autoregulation* (代谢自动调节)：#ce("O2")↓、#ce("CO2")↑、乳酸、腺苷→血管舒张
...
- 短期调节：
  ...
  - *Chemoreceptor reflex* (化学感受器反射)：#ce("O2")↓、#ce("CO2")↑、H+↑

- 长期调节：
  - *Renin-angiotensin-aldosterone system* (RAAS, 肾素-血管紧张素-醛固酮系统)
  - 肾脏对血容量的调节

= 第15章 免疫系统 (Chapter 15: The Immune System)
...
- T细胞需要*MHC* (主要组织相容性复合体)呈递抗原
  - *MHC class I*：所有有核细胞，呈递给CD8+ T细胞
  - *MHC class II*：抗原呈递细胞，呈递给CD4+ T细胞
...
= 第16章 呼吸生理学 (Chapter 16: Respiratory Physiology)
...
- 遵循*Fick's law* (菲克定律)：扩散速率∝表面积×浓度梯度/厚度
...
- #ce("O2")运输：
  - 98.5%与血红蛋白结合
  - 1.5%溶解于血浆
  - *Oxyhemoglobin dissociation curve* (氧合血红蛋白解离曲线)：S形
  - 右移：#ce("CO2")↑、H+↑、温度↑、*2,3-DPG*↑(促进#ce("O2")释放)
...
- 化学调节：
  - *Central chemoreceptors* (中枢化学感受器)：延髓，对#ce("CO2")/H+敏感
  - *Peripheral chemoreceptors* (外周化学感受器)：颈动脉体和主动脉体，对#ce("O2")、#ce("CO2")、H+敏感

= 第17章 肾脏生理学 (Chapter 17: Physiology of the Kidneys)
...
- 水平衡和渗透压调节
- 电解质平衡：#ce("Na+")、#ce("K+")、#ce("Ca2+")、#ce("Cl-")等
- 酸碱平衡：排泄H+、重吸收#ce("HCO3-")
- *Renin-angiotensin-aldosterone system* (RAAS)：
  - 肾素(renin)→血管紧张素原→血管紧张素I→血管紧张素II
  - 效应：血管收缩、醛固酮释放、口渴

= 第18章 消化系统 (Chapter 18: The Digestive System)
...
- 胃液成分：
  ...
  - *Intrinsic factor* (内因子)：维生素#ce("B12")吸收
  - *Mucus* (黏液)：保护胃黏膜
...
= 第19章 代谢调节 (Chapter 19: Regulation of Metabolism)

== 营养物质代谢 (Nutrient Metabolism)

- 碳水化合物代谢：
  - *Glycolysis* (糖酵解)：葡萄糖→丙酮酸，产生ATP
  - *Krebs cycle* (克雷布斯循环/三羧酸循环)：丙酮酸完全氧化
  - *Electron transport chain* (ETC, 电子传递链)：产生大量ATP
...
= 第20章 生殖 (Chapter 20: Reproduction)
...
- 性激素功能：
  - *Estrogen* (雌激素)：第二性征、子宫内膜增生、排卵前LH激增
...
- 负反馈调节：性激素抑制GnRH、FSH、LH分泌
- 正反馈：雌激素高峰触发LH激增(排卵前)

#align(center)[
#text(1.2em, strong("总结完毕"))
]
