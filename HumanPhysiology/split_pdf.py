...
def split_pdf_by_bookmarks(bookmark_file, pdf_file):
    ...
    for item in root.findall('.//ITEM'):
        ...
        # Filter for chapters: INDENT == '1' and name starts with 'CHAPTER'
...
if __name__ == '__main__':
    split_pdf_by_bookmarks('Human Physiology 12th 2010 Bookmark.xml', '【07】Human Physiology 12th 2010.pdf')
