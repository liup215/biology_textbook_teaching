...
#align(center, text(2em, weight: "bold")[Chapter 10: Cooperation])
...
- Experimental evidence in elephants demonstrates their ability to coordinate actions to achieve a goal.
  ...
  - #figure(
      image(images.at("figure-10-1").path, width: 50%),
      caption: images.at("figure-10-1").caption
    )
...
- #figure(
    image(images.at("figure-10-2").path, width: 50%),
    caption: images.at("figure-10-2").caption
  )
...
- #figure(
    image(images.at("figure-10-3").path, width: 50%),
    caption: images.at("figure-10-3").caption
  )

= Paths to Cooperation

- Four main paths to the evolution of cooperation have been identified: *kin selection*, *reciprocity*, *byproduct mutualism*, and *group selection*.
- #figure(
    image(images.at("figure-10-4").path, width: 50%),
    caption: images.at("figure-10-4").caption
  )
...
- #figure(
    ...
    caption: images.at("table-10-1").caption
  )
...
- TFT can resist invasion by "Always Defect" (ALLD) if the probability of future interaction ($w$) meets the condition:
  - $w > (T - R) / (T - P)$
- TFT can resist invasion by "Alternate Defect and Cooperate" (ALTDC) if:
  - $w > (T - R) / (R - S)$
- #figure(
    image(images.at("figure-10-5").path, width: 50%),
    caption: images.at("figure-10-5").caption
  )
...
- #figure(
    image(images.at("figure-10-6").path, width: 50%),
    caption: images.at("figure-10-6").caption
  )
...
- #figure(
    image(images.at("table-10-2").path, width: 50%),
    caption: images.at("table-10-2").caption
  )
- Evidence supports the risk differential: inspectors are more likely to be eaten the closer they get.
- #figure(
    image(images.at("figure-10-7").path, width: 50%),
    caption: images.at("figure-10-7").caption
  )
- Information is transferred from inspectors to non-inspectors.
- #figure(
    image(images.at("figure-10-8").path, width: 50%),
    caption: images.at("figure-10-8").caption
  )
- In the wild, inspection behavior varies with the danger level of the predator's body part (head vs. tail).
- #figure(
    image(images.at("figure-10-9").path, width: 50%),
    caption: images.at("figure-10-9").caption
  )
- Guppies appear to use a TFT-like strategy: they are nice (start inspecting), retaliatory (stop if partner stops), and forgiving.
- #figure(
    image(images.at("figure-10-10").path, width: 50%),
    caption: images.at("figure-10-10").caption
  )
...
- #figure(
    image(images.at("figure-10-11").path, width: 50%),
    caption: images.at("figure-10-11").caption
  )
- Food sharing depends on both relatedness and reciprocity.
- #figure(
    image(images.at("figure-10-12").path, width: 50%),
    caption: images.at("figure-10-12").caption
  )
- Bats are more likely to regurgitate blood to those who have fed them in the past (reciprocity) and to close kin.
- #figure(
    image(images.at("figure-10-13").path, width: 50%),
    caption: images.at("figure-10-13").caption
  )

=== Neurobiological Underpinnings of Human Reciprocity
...
- #figure(
    image(images.at("table-10-3").path, width: 50%),
    caption: images.at("table-10-3").caption
  )
- fMRI scans confirm that mutual cooperation is emotionally rewarding.
- #figure(
    image(images.at("figure-10-14").path, width: 50%),
    caption: images.at("figure-10-14").caption
  )
...
- #figure(
    image(images.at("figure-10-15").path, width: 50%),
    caption: images.at("figure-10-15").caption
  )
...
- #figure(
    image(images.at("figure-10-16").path, width: 50%),
    caption: images.at("figure-10-16").caption
  )
...
- #figure(
    image(images.at("figure-10-17").path, width: 50%),
    caption: images.at("figure-10-17").caption
  )
...
- #figure(
    image(images.at("table-10-4").path, width: 50%),
    caption: images.at("table-10-4").caption
  )
- The jays adjusted their behavior based on the payoff matrix presented.
- #figure(
    image(images.at("figure-10-18").path, width: 50%),
    caption: images.at("figure-10-18").caption
  )
...
- #figure(
    image(images.at("figure-10-19").path, width: 50%),
    caption: images.at("figure-10-19").caption
  )
...
- Example: Desert seed harvester ant (*Messor pergandei*).
  ...
  - #figure(
      image(images.at("table-10-5").path, width: 50%),
      caption: images.at("table-10-5").caption
    )
  - Once workers emerge, queens become aggressive and fight (within-group selection takes over).
  - #figure(
      image(images.at("figure-10-20").path, width: 50%),
      caption: images.at("figure-10-20").caption
    )
- Example: Leaf-cutter ant (*Acromyrmex versicolor*).
  ...
  - #figure(
      image(images.at("figure-10-21").path, width: 50%),
      caption: images.at("figure-10-21").caption
    )
  - Despite the risk, reproductive output is shared equally among queens.
  - #figure(
      image(images.at("table-10-6").path, width: 50%),
      caption: images.at("table-10-6").caption
    )
...
- #figure(
    image(images.at("figure-10-22").path, width: 50%),
    caption: images.at("figure-10-22").caption
  )

== Conservation Connection: Tragedy of the Commons
...
- #figure(
    image(images.at("figure-10-23").path, width: 50%),
    caption: images.at("figure-10-23").caption
  )
...
- #figure(
    image(images.at("figure-10-24").path, width: 50%),
    caption: images.at("figure-10-24").caption
  )
...
- #figure(
    image(images.at("figure-10-25").path, width: 50%),
    caption: images.at("figure-10-25").caption
  )
...
- #figure(
    image(images.at("figure-10-26").path, width: 50%),
    caption: images.at("figure-10-26").caption
  )
...
- #figure(
    image(images.at("figure-10-27").path, width: 50%),
    caption: images.at("figure-10-27").caption
  )
...
- #figure(
    image(images.at("figure-10-28").path, width: 50%),
    caption: images.at("figure-10-28").caption
  )
- Butterfly survival is significantly higher when ants are present.
- #figure(
    image(images.at("figure-10-29").path, width: 50%),
    caption: images.at("figure-10-29").caption
  )
- Communication plays a role: butterfly pupae produce vibrations (*stridulation*) to attract ants.
- #figure(
    image(images.at("figure-10-30").path, width: 50%),
    caption: images.at("figure-10-30").caption
  )
