...
def split_pdf_by_bookmarks(bookmark_file, pdf_file):
    ...
    for item in root.findall('.//ITEM'):
        ...
        if name and page_str and indent == '1':
            try:
                # Page numbers in this XML are 0-based, so add 1 to match pypdf's 0-based indexing logic.
                page = int(page_str) + 1
                if page < 1:
...
if __name__ == '__main__':
    split_pdf_by_bookmarks('Evolution_Bookmark.xml', 'Evolution.pdf')
