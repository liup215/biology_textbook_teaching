...
#show: stargazer-theme.with(
  config-info(
    title: "Adaptations to the Physical Environment: Light, Energy, and Heat",
    subtitle: "Ecology",
    author: "Author Name",
...
== Key Concepts
#slide[
  - Light is the fundamental energy source for all life, driving photosynthesis and influencing Earth's thermal conditions. Without sunlight, ecosystems would lack the energy needed for biological processes.
...
== Boundary Layers
#slide[
  - Boundary layers of unstirred water surrounding aquatic plants slow the diffusion of CO₂, bicarbonate, and oxygen, limiting the rate of photosynthesis and respiration in aquatic environments.
][
  #figure(
...
#slide[
  - Bicarbonate ions replenish dissolved CO₂ as it is used by aquatic plants and algae during photosynthesis. The chemical equilibrium ensures a continuous supply of CO₂ from bicarbonate, supporting carbon assimilation in aquatic ecosystems.
][
  #figure(
...
== Radiation Loss
#slide[
  - Thermal images show how organisms lose heat to the environment by radiation. Body regions such as the head, neck, and legs may lose heat more rapidly, affecting overall thermal balance.
][
  #figure(
...
== Coupled Budgets
#slide[
  - The heat, water, food, and salt budgets of animals are physiologically coupled. Diet, evaporative water loss, and excretion interact to maintain homeostasis and support survival in changing environments.
][
  #figure(
